/**
 * Tool registry for Lesotho Law MCP Server.
...
import { getLesothoImplementations, type GetLesothoImplementationsInput } from './get-lesotho-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Lesotho Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Lesotho legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Lesotho statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Lesotho proclamation or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Lesotho legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Lesotho statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Lesotho?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Lesotho legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Lesotho proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Lesotho statute aligns with or references. ' +
      'Lesotho is not an EU member but several Lesotho laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Lesotho statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_lesotho_implementations',
    description:
      'Find all Lesotho statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Lesotho statutes. ' +
      'Note: Lesotho implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Lesotho implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_lesotho_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Lesotho aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Lesotho statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Lesotho statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_lesotho_implementations':
          result = await getLesothoImplementations(db, args as unknown as GetLesothoImplementationsInput);
          break;
