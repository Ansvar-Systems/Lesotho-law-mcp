 ...
 *
 * Enumerates ALL proclamations, regulations, and directives from lawlesotho.com.
...
const BASE_URL = 'https://www.lawlesotho.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-lesotho',
  ...
  'parliament', 'police', 'president-of-lesotho', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawlesotho.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Lesotho Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Lesotho (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
